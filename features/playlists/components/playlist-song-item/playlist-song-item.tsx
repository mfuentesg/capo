...
export function PlaylistSongItem({ song, index, className, showDragHandle }: PlaylistSongItemProps) {
  return (
    <div
      className={cn(
        "group flex items-start gap-4 rounded-xl bg-elevated-surface border border-border/60 shadow-sm p-4 transition-shadow hover:shadow-md hover:border-border",
